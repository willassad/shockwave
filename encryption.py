...
def mainEandD(): #Interactive 
    ...
    while counter:
        while counter2:
            func = raw_input('Encrypt or Decrypt: ')
            print(' ')
            if func.lower() == 'e':
                ...
                while True:
                    ...
                    if fOrw.lower().rstrip() == 'w':
                        ...
                        while True:
                            try:
                                wordraw_input = raw_input('Enter Filename: ')
                                print(' ')
                                print('Encrypting...')
                                print(' ')
                                word = open(wordraw_input, 'r+')
                ...
                while True:
                    ...
                    if fOrw.lower().rstrip() == 'w':
                        while True:
                            try:
                                encryptedWord = eval(raw_input('Enter Encrypted Word: ').rstrip())
                                print(' ')
                                print('Decrypting...')
                                print(' ')
